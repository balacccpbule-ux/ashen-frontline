...
(function () {
  ...
  const STR = {
    zh: {
      ...
      'menu.desc': '16v16 大战场 · 双模式 · 四地图 · 六兵种 · 陆空载具 · 全域破坏',
      'menu.mode': '游戏模式',
      'menu.map': '战场地图',
      'menu.diff': 'AI 难度',
      'mode.conquest': '征服模式',
    ...
    en: {
      ...
      'menu.subtitle': 'ASHEN FRONTLINE',
      'menu.desc': '16v16 battlefield · 2 modes · 4 maps · 6 classes · land & air vehicles · full destruction',
      'menu.mode': 'GAME MODE',
  ...
  const EN = {
    name: {
      ...
      '灰烬都市': 'Ashen City', '沙暴行动': 'Operation Sandstorm',
