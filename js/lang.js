...
(function () {
  ...
  const STR = {
    zh: {
      ...
      'menu.controls.2': 'R 换弹 · 1/2/3 切换武器 · G 手雷 · Q/E 歪头 · F 上下车 · Tab 计分板',
      'class.title': '选择兵种',
      'class.deploy': '部署',
      'hud.exit': '退出对局',
      ...
      'merit.spot': '标记',
      'merit.vehicle': '载具摧毁',
      'merit.vehicleAssist': '载具助攻',
      'merit.spotAssist': '侦察助攻',
      'merit.ammo': '补给弹药',
      'merit.heal': '治疗',
      'merit.capture': '占领',
      'merit.multi': '多杀',
    ...
    en: {
      ...
      'menu.controls.2': 'R reload · 1/2/3 switch weapon · G grenade · Q/E lean · F enter/exit · Tab scoreboard',
      ...
      'merit.vehicleAssist': 'Vehicle Assist',
      'merit.spotAssist': 'Spot Assist',
  ...
  const EN = {
    ...
    desc: {
      ...
      '冲锋枪近战 + 火箭筒反载具，可维修载具（按住 T）+ 烟雾弹掩护（H）': 'SMG + rocket launcher vs vehicles, repairs vehicles (hold T) + smoke cover (H)',
